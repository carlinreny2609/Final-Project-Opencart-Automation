...
@Test(priority = 1)
public class user_registrationtest extends Variables {
	...
	public void user_registration() throws InterruptedException, IOException {
		...
		Assert.assertEquals(Actualregistersuccess, Expectedregistersuccess, "User not registered successfully");
